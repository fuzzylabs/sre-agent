...
def cli(ctx, version, config_path):
    ...
    if ctx.invoked_subcommand is None:
        ...
        console.print("  [bright_cyan]1.[/bright_cyan] [cyan]sre-agent config setup[/cyan]           # Quick setup (essential features)")
        console.print("  [bright_cyan]2.[/bright_cyan] [cyan]sre-agent diagnose --service myapp[/cyan]  # Start debugging!")
